...
const routes = [
  ...
  {path:"/dashbord", name:'dashBord', component:()=>import('../pages/dashbord/dashBord.vue')},
  ...
  { path: "/courseDetails", name: "coursDetails", component: () => import('../pages/courses/coursDetails.vue') },
];
